	...
	return (
		<div className="text-center">
			<div className="max-w-xl mx-auto px-4 mb-10">
				<h1 className="font-black text-4xl text-neutral-700 mb-5">
			...
			<div className="max-w-xl mx-auto px-4">
				...
				<div className="relative">
					...
					<button
					type="submit"
					className="flex items-center gap-2 absolute top-1/2 right-2 transform -translate-y-1/2 bg-neutral-700 hover:bg-neutral-800 text-white font-semibold px-6 py-3 rounded-full transition text-base"
					>
					Subscribe
